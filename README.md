...
- Workflow `.github/workflows/check_keys.yml` запускается раз в 3 часа по `schedule` и вручную через `workflow_dispatch`.
...
- Чтобы уменьшить такие пропуски, cron смещён с начала часа на `17` минуту и сейчас идёт по `00:17`, `03:17`, `06:17`, `09:17`, `12:17`, `15:17`, `18:17`, `21:17` UTC.
